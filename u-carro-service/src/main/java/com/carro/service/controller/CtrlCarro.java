...
import com.carro.service.service.SvcCarro;
...
{
	@Autowired
	private SvcCarro svcCarro;
	
	@GetMapping
	public ResponseEntity<List<Carro>> listarCarros()
	{
		List<Carro> carros = svcCarro.getAll();
		if (carros.isEmpty())
		{
	...
	{
		Carro carro = svcCarro.getCarroById(id);
		if (carro == null)
		{
	...
	{
		Carro nuevoCarro = svcCarro.save(carro);
	...
	{
		List<Carro> carros = svcCarro.byUsuarioId(id);
		if (carros.isEmpty())
		{
			return ResponseEntity.noContent().build();	
		}
